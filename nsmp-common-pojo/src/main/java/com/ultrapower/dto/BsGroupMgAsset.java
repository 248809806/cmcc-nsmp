...
public class BsGroupMgAsset implements Serializable {
    ...
    public BsGroupMgAsset() {
    }

    public BsGroupMgAsset(String PK_BS_GROUP, String g_BS_NAME, String PROV_CODE, String PROV_NAME, String PK_BS_PROV, String p_BS_NAME, String PK_ASSET, String ASSET_NAME, String ASSET_IP, String PK_ASSET_TYPE, String TYPE_NAME) {
